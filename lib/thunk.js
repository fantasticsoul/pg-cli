...
exports.queryWithTransaction = require('thunkify')(pgManager.queryWithTransaction);
 ...
 */
exports.insert = function(tableName, toInsert){
  return function (cb) {
    pgManager.insert(tableName, toInsert, cb);
  }
};
 ...
 */
exports.insertBatch = function(tableName, toInserts){
  return function (cb) {
    pgManager.insertBatch(tableName, toInserts, cb);
  }
};
 ...
 */
exports.update = function(tableName, filter, toUpdate){
  return function (cb) {
    pgManager.update(tableName, filter, toUpdate, cb);
  }
};
