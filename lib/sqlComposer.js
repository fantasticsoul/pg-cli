 ...
 * @returns {*}
 */
function prepareSelectSql(tableName, fields, filter, needArgs) {
  var sql = 'select ';
  var args = null;
  if (needArgs) args = [];
 ...
 *  'PRCampaign',
 * [
 *    {path:['a','b',1],newValue:{s:1,e:1}},
 *    {path:'{"a","c"}',newValue:'{"s":1,"e":1}'}
 * ]
 * output:
 ...
 */
function prepareUpdateSql(tableName, toUpdate, filter, returnFields, needArgs) {
